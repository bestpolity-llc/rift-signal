...
notes = [
    ...
    "Set One: clean crew cards, with names and invisible OK navigation.",
...
print("Clean crew cards and science visuals included; no placeholder topic cards.")
